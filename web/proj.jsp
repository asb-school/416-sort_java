...
<div data-role="page" id="get_num_items">
	...
	<div data-role="content" >	
        ...
        <form id="get_num_items_form" action="proj.jsp#input_items" method="get" data-ajax="false">
...
<div data-role="page" id="input_items">
	...
	<div data-role="content" >	
        ...
        <p>Total number of items is <% out.print(request.getParameter("num_items")); %></p>
		
      <form id="input_items_form" data-ajax="false">

      	
			<div data-role="fieldcontain">
	         			<input type="hidden" name="number_of_items" value="<% out.print(request.getParameter("num_items")); %>" />
			</div>
...
<div data-role="page" id="list_items">
	...
	<div data-role="content" >	
        ...
        <form action="proj.jsp#list_items" method="post">
			<div data-role="fieldcontain">
